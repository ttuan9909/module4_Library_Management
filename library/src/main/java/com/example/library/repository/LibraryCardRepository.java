...
/**
 * Repository cho entity {@link LibraryCard}.
 * Cung cấp các phương thức CRUD cơ bản và các truy vấn tùy chỉnh.
 */
@Repository
public interface LibraryCardRepository extends JpaRepository<LibraryCard, Long> {
     ...
     * @return Optional<LibraryCard> chứa thẻ nếu tìm thấy
     */
     ...
     * @return true nếu thẻ đã tồn tại
     */
     ...
     * @return Optional<LibraryCard> chứa thẻ của người dùng
     */
    Optional<LibraryCard> findByUser_UserId(Long userId);

    /**
     * Xóa thẻ thư viện bằng userId.
     * Dùng khi xóa UserAccount để tránh vi phạm ràng buộc FK.
     *
     * @param userId ID của người dùng
     */
